...
white_veh = pyoscx.Vehicle('vehicle.volkswagen.t2',pyoscx.VehicleCategory.car,bb,fa,ba,69,10,10)
white_veh.add_property(name='type',value='ego_vehicle')
bb = pyoscx.BoundingBox(1.8,4.5,1.5,1.3,0,0.8)
fa = pyoscx.Axle(0.523598775598,0.8,1.68,2.98,0.4)
ba = pyoscx.Axle(0.523598775598,0.8,1.68,0,0.4)
red_veh = pyoscx.Vehicle('vehicle.tesla.model3',pyoscx.VehicleCategory.car,bb,fa,ba,69,10,10)
red_veh.add_property(name='type',value='simulation')
