...
class AssignControllerAction(_PrivateActionType):
    ...
    def get_element(self):
        ...
        BrakAct = OverrideBrakeAction(value='0',activate=False).get_attributes()
        ClutAct = OverrideClutchAction(value='0',activate=False).get_attributes()
        ParkBrakAct = OverrideParkingBrakeAction(value='0',activate=False).get_attributes()
        SteerAct = OverrideSteeringWheelAction(value='0',activate=False).get_attributes()
