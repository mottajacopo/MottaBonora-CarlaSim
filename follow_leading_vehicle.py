...
# ==============================================================================
        ...
        first_vehicle = CarlaDataProvider.request_new_actor(vehicle_name, first_vehicle_transform)   # vehicle_name is a random vehicle model
    ...
    def _create_behavior(self):
        ...
        sequence.add_child(ChangeAutoPilot(self.other_actors[0], True))   #activated autopilot for leading vehicle
